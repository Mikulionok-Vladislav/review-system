...
<?php $view->component('start'); ?>
    <main>
        <div class="container">
            <h3 class="mt-3">Изменение отеля</h3>
            <hr>
        </div>
        <div class="container">
            <form action="/admin/hotels/update" method="post" enctype="multipart/form-data" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
                ...
                <div class="row g-2">
                    <div class="col-md">
                        <div class="form-floating">
                            ...
                            ><?php echo $hotel->description() ?></textarea>
