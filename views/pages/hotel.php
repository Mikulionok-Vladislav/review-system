        ...
        <div class="container">
            <div class="one-movie">
                <div class="card mb-3 mt-3 one-movie__item">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <img src="<?php echo $storage->url($hotel->preview()) ?>" class="img-fluid rounded one-movie__image" alt="<?php echo $hotel->name() ?>">
                            <?php if ($auth->check()) { ?>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-body-secondary">Добавлен <?php echo $hotel->createdAt() ?></small></p>
                                <h4>Отзывы</h4>
